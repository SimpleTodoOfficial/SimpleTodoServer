package de.calltopower.simpletodo.impl.filter;
...
import de.calltopower.simpletodo.api.filter.STDFilter;
 ...
 */
public class STDAuthTokenFilter extends OncePerRequestFilter implements STDFilter {
